...
class HloInstruction {
 public:
  ...
  // of this instruction to avoid introducing cycles into the graph. If except
  // is provided, the instruction also remains a use of this instruction.
  //
