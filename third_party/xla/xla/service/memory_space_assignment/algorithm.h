...
class AllocationValue {
 public:
  ...
  struct Use {
    ...
    // A synchronous memory operation operand of this use.
...
// Span<AllocationValue>, whose allocation sequence we will updated, and whether
...
struct AllocationSegmentContext {
  ...
  // vector.
  int use_idx;
  // Index of the AllocationValue in Span<AllocationValue>, whose allocation
  // sequence we will updated.
